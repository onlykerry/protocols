...
/***********************************************************************/
/*       vstat: Obtain information about a mounted volume              */
/*                                                                     */
/*      Inputs: path = volume name                                     */
...
int vstat(const char *path, union vstat *buf)
{
  ...
  /*-------------------------------------------------------------------*/
  /* Call file system specific VSTAT routine.                          */
  /*-------------------------------------------------------------------*/
  rv = (int)fsys->ioctl(NULL, VSTAT, fsys->volume, buf);
